...
! DATA STRUCTURE TO HOLD ALL NSST RECORDS.
 ...
 REAL, ALLOCATABLE, PUBLIC    :: TSFC_GAUS(:,:)  !< GFS TSFC (tref or tsea) on the gaussian
                                                 !!grid.
...
!! @author George Gayno NCEP/EMC
 ...
 SUBROUTINE READ_SFCANL_DATA(SFCANL_FILE, USE_TREF)

 IMPLICIT NONE

 CHARACTER(LEN=*), INTENT(IN)     :: SFCANL_FILE
 LOGICAL, INTENT(IN)              :: USE_TREF
 INTEGER                          :: ERROR, ID_DIM, NCID
 INTEGER                          :: ID_VAR, J
...
! REMOVE POLE POINTS. and flip latitude
 ...
 !!
 !! @param[in] LENSFC Total number of points on a tile.
 !! @param[out] TSFC_TILE foundation temperature
 !! @author Mingjing Tong NOAA/GFDL
 SUBROUTINE READ_SFCANL_TILE_DATA(LENSFC,USE_TREF,TSFC_TILE)
 ...
 LOGICAL, INTENT(IN)       :: USE_TREF
 REAL, INTENT(OUT)         :: TSFC_TILE(LENSFC)
 ...
 TSFC_TILE = RESHAPE(DUMMY, (/LENSFC/))

 print *,'TSFC_TILE ', maxval(TSFC_TILE), minval(TSFC_TILE)
